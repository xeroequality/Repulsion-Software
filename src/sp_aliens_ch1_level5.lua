...
local function restart(event)
	storyboard.labelFile = "sp_aliens_ch1_level5"
...
function scene:enterScene( event )
		...
		function entireLevel()
			...
			level.params = {
				...
				midground = {
					-- Filename, True Image Width & Height, Starting X, Starting Y, and Speed
					img = "../images/background/dallas_skyline.png",
					width = 750,
					height = 450,
					left = 0,
					bottom = H,
			...
			levelWallet = require("levelinfo")[1][5].wallet 	--The Amount of Money for This Level [chapter][level].wallet
			...
			-- Load the enemy base:
			----------------------------
			local objGroup = Enemy.loadBase(Enemy.level5)
