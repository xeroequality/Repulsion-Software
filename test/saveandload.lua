...
--local Player	 = require( "playerbase" )
...
function scene:enterScene( event )
		...
		--           SAVE BUILDING STUFF            --
		----------------------------------------------
		--Save Everything That is a Child
		local index = 0;
		function savingStructure(event)
			--Save Everything that is the Child
			if event.phase == "began" then
				index = 1;
		...
		save:addEventListener("touch",savingStructure);
		load:addEventListener("touch",loadStructure)
end
